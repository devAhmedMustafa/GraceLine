...
const AuthLayout : React.FC = ()=>{
    ...
    return(
        <div className="flex h-screen justify-between flex-col items-center">
            ...
            <div className="bg-background flex items-center gap-4 text-7xl font-bold text-primary selection:bg-none cursor-default">
                <p className="font-hand">Grace</p>
                <img className="solid-shadow-gray" width={140} src={logo} alt="" />
